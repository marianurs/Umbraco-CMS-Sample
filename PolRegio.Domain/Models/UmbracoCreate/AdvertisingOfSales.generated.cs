...
{
	/// <summary>Ogłoszenia o sprzedaży</summary>
	[PublishedContentModel("advertisingOfSales")]
	public partial class AdvertisingOfSales : PublishedContentModel, IMainPageDataWithList, ISeo, ISiteUrl
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "advertisingOfSales";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public AdvertisingOfSales(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<AdvertisingOfSales, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Link do ogłoszeń archiwalnych: Link do ogłoszeń archiwalnych, proszę podać adres z http://www.example.com
		///</summary>
		[ImplementPropertyType("archiveUrl")]
		public string ArchiveUrl
		{
			get { return this.GetPropertyValue<string>("archiveUrl"); }
		}
		...
		{
			get { return MainPageDataWithList.GetDisplayItemCount(this); }
		}
		...
		{
			get { return MainPageDataWithList.GetPageMainTitle(this); }
		}
