...
{
	/// <summary>Artykuł z filtrem</summary>
	[PublishedContentModel("articleWithFilter")]
	public partial class ArticleWithFilter : PublishedContentModel, IArticleBox, IArticleContent, ISeo, ISiteUrl, IUmbracoSalesManagoArticleNotify
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "articleWithFilter";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public ArticleWithFilter(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ArticleWithFilter, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Filtr regionów: Wybierz region
		///</summary>
		[ImplementPropertyType("regionFiltr")]
		public nuPickers.Picker RegionFiltr
		{
			get { return this.GetPropertyValue<nuPickers.Picker>("regionFiltr"); }
		}
