...
{
	/// <summary>Artykuł z filtrami</summary>
	[PublishedContentModel("articleWithDoubleFiltr")]
	public partial class ArticleWithDoubleFiltr : PublishedContentModel, IArticleBox, IArticleContent, ISeo, ISiteUrl, IUmbracoSalesManagoArticleNotify
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "articleWithDoubleFiltr";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public ArticleWithDoubleFiltr(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ArticleWithDoubleFiltr, TValue>> selector)
		{
		...
		public nuPickers.Picker ArticleCategory
		{
			get { return this.GetPropertyValue<nuPickers.Picker>("articleCategory"); }
		}

		///<summary>
		/// Region artykułu
		///</summary>
		[ImplementPropertyType("articleRegions")]
		public nuPickers.Picker ArticleRegions
		{
			get { return this.GetPropertyValue<nuPickers.Picker>("articleRegions"); }
		}
