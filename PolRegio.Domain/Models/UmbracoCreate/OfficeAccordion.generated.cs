...
{
	/// <summary>Oddziały akordeon</summary>
	[PublishedContentModel("officeAccordion")]
	public partial class OfficeAccordion : PublishedContentModel, ISeo, ISiteUrl
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "officeAccordion";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public OfficeAccordion(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<OfficeAccordion, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Lista oddziałów: Podaj dane oddziału
		///</summary>
		[ImplementPropertyType("addOffice")]
		public Archetype.Models.ArchetypeModel AddOffice
		{
			get { return this.GetPropertyValue<Archetype.Models.ArchetypeModel>("addOffice"); }
		}
