...
{
	/// <summary>Wyszukaj połączenie</summary>
	[PublishedContentModel("searchConnection")]
	public partial class SearchConnection : PublishedContentModel, ISeo, ISiteUrl
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "searchConnection";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public SearchConnection(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<SearchConnection, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Link: Wybierz adres wewnętrzny z listy albo wprowadź adres zewnętrzny do przekierowania
		///</summary>
